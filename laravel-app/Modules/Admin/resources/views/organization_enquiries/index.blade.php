...
@section('content')
  ...
  <section class="panel table-panel"><table class="data-table"><thead><tr><th>SL#</th><th>ORGANIZATION</th><th>CONTACT</th><th>GROUP SIZE</th><th>RECEIVED</th><th>STATUS</th><th></th></tr></thead><tbody>@forelse($enquiries as $enquiry)<tr>
  ...
  </tr>@empty<tr><td colspan="7" class="empty">No corporate inquiries yet.</td></tr>@endforelse</tbody></table></section>
