...
<div class="container-fluid px-0">
    <div class="row row-container">
        ...
        <div class="col-xl-6 right-panel-space d-flex flex-column justify-content-center" style="height: auto;">
           ...
           <form style="padding-left: 10px;" action="/sign-up" method="post" enctype="multipart/form-data" id="signupForm">
            @csrf
                ...
                <h3 class="small-link text-purple text-start mt-3 mb-2" style="font-weight: 600">Already have a account ? <a href="/sign-in" style="color:#F1935D;">Sign In</a></h3>
