...
<div class="container-fluid px-0">
    <div class="row align-items-center row-container">
        ...
        <div class="col-xl-6 right-panel-space">
            <h2 class="pt-3 pb-5" style="color: #F1935D; font-weight: 600 !important">Verify OTP</h2>
            ...
            @csrf
                <div class="row px-0 mx-0">
                    <div class="col-lg-6 px-0 ps-lg-0 pe-lg-1">
                        <label for="first-name" class="pb-2 form-label-signup" style="font-weight: 600">Enter OTP</label>
                        <input type="text" class="form-control signup-form-placeholder" id="first-name"
                            placeholder="Enter OTP" required
                            style="border-radius:10px; border-color:rgb(233, 232, 232);"  name="otp">
                ...
                <button type="submit" class="btn btn-custom" style="border-radius: 20px; font-weight: 600">Reset Password</button>
            </form>
        </div>
    </div>
</div>
