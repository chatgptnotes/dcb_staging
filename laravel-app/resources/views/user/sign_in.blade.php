...
@media screen and (min-height: 620px) and (min-width: 1024px) {
  .left-panel {
    height: calc(100vh - 92px);
  }
...
<div class="container-fluid px-0">
    <div class="row align-items-center row-container">
        ...
        <div class="col-xl-6 right-panel-space">
            <h2 class="pt-3 pb-5" style="color: #F1935D; font-weight: 600 !important">Your future starts here - Sign in</h2>
            ...
            @csrf
                <input type="hidden" name="intended_package" value="{{ session('intended_package') }}">
                <div class="row px-0 mx-0">
                    <div class="col-lg-6 px-0 ps-lg-0 pe-lg-1">
                        <label for="first-name" class="pb-2 form-label-signup" style="font-weight: 600">User Name</label>
                    ...
                    <div class="col-lg-6 px-0 ps-lg-1 pe-lg-0">
                        <label for="last-name" class="pb-2 form-label-signup"  style="font-weight: 600">Password</label>
                ...
                <div class="row px-0 mx-0  mt-3 mb-2">
                    <div class="col-6 text-start">
                        <a href="{{url('forgot-password')}}" class="small-link" style="color:#F1935D;font-weight: 600;">Forgot Password ?</a>
                    </div>
                    <div class="col-6 text-end">
                        <h3 class="small-link text-purple" style="font-weight: 600">No account? <a href="/sign-up" style="color:#F1935D;">Sign Up</a></h3>
                    </div>
                </div>
                
                <button type="submit" class="btn btn-custom" style="border-radius: 20px; font-weight: 600">Sign In</button>
            </form>
        </div>
    </div>
</div>
