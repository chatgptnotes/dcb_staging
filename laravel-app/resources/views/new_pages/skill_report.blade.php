    ...
    <div>
        ...
        <div class="dashboard-page-content pb-5">
            <div class=" p-0 w-100">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Analytical Brain / Candid</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Practical Thinker / Structured</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Maverick Creative Thinker / Visionary</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Relational Brain / Empathetic</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Dual Analytical-Practical / Structured Analyst
                </h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Relational Creative / Empathetic Visionary</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Innovative Analyst / Creative Problem-Solver</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Practical Empath / Grounded Relational Thinker
                </h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Analytical Connector / Relational Analyst</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Practical Innovator / Grounded Creative</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Abstract Idealist / Relational Planner</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Visionary Dreamer / Conceptual Creative</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Grounded Thinker / Structured Planner</h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5" style="color:#f1935d">Independent Problem-Solver / Analytical
                    Innovator
                </h2>
                <p class="report-normal-text mt-4">
                ...
                <h2 class="report-heading col-lg-6 pt-5">No Skill Report Found
                </h2>
        ...
        <div class="container  d-flex flex-column align-items-center justify-content-center">
            ...
            <h3 class="heading1 text-purple text-center">Find Your Brain Code – Discover How You Think!</h3>
            <p class="question-paragraph text-center">This fun and insightful test takes just <strong>a few minutes </strong>to complete. Be <strong>honest and spontaneous </strong>— there are no right or wrong answers!</p>
            
            <ol>
            <li>Choose the <strong>option that feels most like you</strong> — your <strong>top preference.</strong></li>
            <li>Then pick your <strong>second choice</strong>, what also fits you well.</li>
            <li>Next, select your <strong>third choice</strong>, the one that’s somewhat true for you.</li>
            <li>Finally, choose your <strong>least like you</strong> option — the one that describes you the least.</li>
            </ol>
            <p class="question-paragraph">Your answers will unlock your unique <strong>Brain Preference Pattern</strong>, showing how your mind learns, thinks, and solves problems best!</p>
