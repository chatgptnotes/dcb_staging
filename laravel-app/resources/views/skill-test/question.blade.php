...
<section class="section-margin-bottom section-margin-top">
    ...
    <!-- <h5 class="step-txt">Step 01/02</h5> -->
        <h3 class="section-title text-purple">Neuro Skills Decoded</h3>
         <p class="p1 ">Discover how your brain uses its natural skills to think, learn, and perform.
For each statement, <strong>rank the 4 options</strong>— from what feels<strong>most like you</strong> to <strong>least like you.</strong> Be honest and spontaneous — your <strong>first instinct</strong> shows your real brain strength!</p>
      
        <div class="tab3 d-flex flex-column-reverse flex-lg-row row mt-5" style="border: 1px solid #F0F0F0;">
            
            <div class="col-lg-8">
             <p style="font-weight: 300 !important;">Choose in this order:</p>    
        <ol>
            <li><strong>Top Preference </strong>– Describes you the best; what you naturally do first.</li>
            <li><strong>Second Choice </strong>– Also fits you well in most situations.</li>
            <li><strong>Third Choice </strong>– Sometimes true, but not your usual way.</li>
            <li><strong>Least Like You </strong>– Rarely or never feels like you.</li>
        </ol>
               
                @if (session('message'))
                <p style="color:red;font-size:14px;">{{ session('message') }}</p>
                @endif
                <h1 class="question-title  mt-4"  style="font-weight: 600 !important;">
                ...
                <div class="answers-container">
                    ...
                    <h1 class="small-link text-start text-purple mt-4" style="cursor:pointer; font-weight: 600 !important;" onclick="resetAnswer()">
    ...
    <img src="{{ asset('assets/images/img773.png') }}" alt="Question Image" class="img-fluid">
</div>
        </div>
    </div>
</section>

<section class="footer-nav  border-top">
   ...
   <br>
    <div class="container">
        <div class="row align-items-center">
            ...
            <h5 class="question-count text-center" style="min-width: 190px">
